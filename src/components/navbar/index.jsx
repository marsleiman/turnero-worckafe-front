        ...
        return (
            <nav class="bg-orange-900 border-bg-orange-900 dark:bg-orange-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <img src="https://st4.depositphotos.com/16781356/40357/v/950/depositphotos_403577868-stock-illustration-coffee-logo-design-vector-illustration.jpg" className="h-11 rounded-full" alt="Flowbite Logo" />
                    </Link>
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-orange-900 dark:border-gray-700">
                            <li>
                            <Link to="/" className="block py-2 px-3 text-white bg-green-300 rounded md:bg-transparent md:text-green-300 md:p-0 dark:text-white md:dark:text-green-300" aria-current="page">Home</Link>
                            </li>
                            <li>
                            <Link to="/listado-reservas/" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-300 md:p-0 dark:text-white md:dark:hover:text-green-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Mis reservas</Link>
                            </li>
